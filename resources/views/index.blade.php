            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p>A. Cafe is one of the best restaurant HTML templates with Bootstrap v4.5.2 CSS framework. You can download and feel free to use this website template layout for your restaurant business. You are allowed to use this template for commercial purposes. <br>
                        <div class="row">
                            <div class="col-4">
                ...
                <div class="owl-menu-item owl-carousel">
                    ...
                    <div class="item">
                        <div class='card card2'>
                            ...
                            <div class='info'>
                              <h1 class='title'>Kiwi Pancake</h1>
                              <p class='description'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sedii do eiusmod teme.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                    ...
                    <div class="item">
                        <div class='card card3'>
                            ...
                            <div class='info'>
                              <h1 class='title'>Tall Flaky Bread</h1>
                              <p class='description'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sedii do eiusmod teme.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                    ...
                    <div class="item">
                        <div class='card card4'>
                            ...
                            <div class='info'>
                              <h1 class='title'>Blueberry Cake</h1>
                              <p class='description'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sedii do eiusmod teme.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                    ...
                    <div class="item">
                        <div class='card card5'>
                            ...
                            <div class='info'>
                              <h1 class='title'>Red Velvet Cupcake</h1>
                              <p class='description'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sedii do eiusmod teme.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                        <form id="contact" action="/add_reservation" method="POST">
                            @csrf
                          <div class="row">
                            {{-- @if (session('status')) --}}
                           ...
                           {{-- <div class="col-lg-12 main-white-button">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <input name="phone_number" type="text" id="phone" placeholder="Phone Number*">
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <select value="no_of_guests" name="no_of_guests" id="no_of_guests">
                                    <option value="no_of_guests" disabled selected>Number Of Guests</option>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <select value="time" name="type_of_menu" id="time">
                                    <option value="time" disabled selected>Time (Menu)</option>
                            ...
                            <div class="col-lg-12">
                                <textarea name="description" rows="6" id="message" placeholder="Message"></textarea>
                            </div>
                            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-4 offset-lg-4 text-center">
                        <div class="section-heading">
                            ...
                            <h6>Select a Reservation to View</h6>
                        </div>
                    </div>
                </div>
                <div class="row">
                    @foreach($reservation as $r)
                        <div class="col-lg-4 mb-4">
                            <div class="chef-item py-4">
                                <a href="/edit_reservation/{{$r->id}}" class="down-content">
                                    <h4>{{$r->name}}</h4>
                                    <span>{{$r->type_of_menu}} for {{$r->no_of_guests}} guests for the {{$r->date}}.</span>
                                </a>
                            </div>
                        </div>
                    @endforeach
